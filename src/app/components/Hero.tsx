...
const Hero = (props: Props) => {
  return (
	...
	<div className="container grid gap-6 mx-auto text-center lg:my-8 lg:grid-cols-2 xl:grid-cols-5">
		<div className="w-full px-6 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 dark:bg-gray-900">
			<h1 className="flex items-start text-5xl lg:font-[24px] sm:font-[16px] dark:text-gray-50">We Build Very</h1>
            <h1 className="flex items-start text-5xl lg:font-[24px] sm:font-[16px] dark:text-gray-50">Modern and</h1>
        	<h1 className="flex items-start whitespace-nowrap text-5xl lg:font-[24px] sm:font-[16px] dark:text-gray-50">Stylish Buildings.</h1>
        ...
        <div className='relative xl:col-span-3 sm:mx-8'>
  ...
  alt="" className="object-cover lg:w-[737px] lg:h-[549px] sm:w-[487px] sm:h-[449px] rounded-md " />
